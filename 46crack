...
getgenv().StandConfig = {
    ...
    ['AutoMask'] = true, --[true | false] Auto Buy Mask When The Stand and Respawn
    ['FPSCAP'] = 30, --[false | 'NUMBER'] This is so your main account gets the most fps (MAXED IS 60, SUGGEST 30 FPS ON STANDS)
